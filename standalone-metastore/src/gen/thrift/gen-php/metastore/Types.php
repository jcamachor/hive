...
class Table {
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['creationSignature'])) {
        $this->creationSignature = $vals['creationSignature'];
      }
    }
  }
      ...
      switch ($fid)
      {
        ...
        case 16:
          if ($ftype == TType::MAP) {
            ...
            {
              $key186 = '';
              $val187 = new \metastore\NotificationEvent();
  ...
  public function write($output) {
    ...
    if ($this->creationSignature !== null) {
      if (!is_array($this->creationSignature)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem557 = null;
              $elem557 = new \metastore\NotificationEvent();
  ...
  public function write($output) {
    ...
    if ($this->events !== null) {
      ...
      $xfer += $output->writeFieldBegin('events', TType::LST, 1);
      {
        ...
        {
          foreach ($this->events as $iter558)
          {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            for ($_i569 = 0; $_i569 < $_size565; ++$_i569)
            {
              ...
              $this->filesAddedChecksum []= $elem570;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->filesAdded !== null) {
      ...
      $xfer += $output->writeFieldBegin('filesAdded', TType::LST, 2);
      {
        ...
        {
          foreach ($this->filesAdded as $iter571)
          {
    ...
    if ($this->filesAddedChecksum !== null) {
      ...
      $xfer += $output->writeFieldBegin('filesAddedChecksum', TType::LST, 3);
      {
        ...
        {
          foreach ($this->filesAddedChecksum as $iter572)
          {
  ...
  public function write($output) {
    ...
    if ($this->partitionVals !== null) {
      ...
      $xfer += $output->writeFieldBegin('partitionVals', TType::LST, 5);
      {
        ...
        {
          foreach ($this->partitionVals as $iter579)
          {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::MAP) {
            ...
            {
              $key585 = 0;
              $val586 = new \metastore\MetadataPpdResult();
              $xfer += $input->readI64($key585);
              $val586 = new \metastore\MetadataPpdResult();
              $xfer += $val586->read($input);
              $this->metadata[$key585] = $val586;
            }
            $xfer += $input->readMapEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->metadata !== null) {
      ...
      $xfer += $output->writeFieldBegin('metadata', TType::MAP, 1);
      {
        ...
        {
          foreach ($this->metadata as $kiter587 => $viter588)
          {
            $xfer += $output->writeI64($kiter587);
            $xfer += $viter588->write($output);
          }
        }
        $output->writeMapEnd();
      }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::MAP) {
            ...
            $_ktype597 = 0;
            $_vtype598 = 0;
            $xfer += $input->readMapBegin($_ktype597, $_vtype598, $_size596);
            for ($_i600 = 0; $_i600 < $_size596; ++$_i600)
            {
              $key601 = 0;
              $val602 = '';
              $xfer += $input->readI64($key601);
              $xfer += $input->readString($val602);
              $this->metadata[$key601] = $val602;
            }
            $xfer += $input->readMapEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->metadata !== null) {
      ...
      $xfer += $output->writeFieldBegin('metadata', TType::MAP, 1);
      {
        ...
        {
          foreach ($this->metadata as $kiter603 => $viter604)
          {
            $xfer += $output->writeI64($kiter603);
            $xfer += $output->writeString($viter604);
          }
        }
        $output->writeMapEnd();
      }
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem610 = null;
              $xfer += $input->readI64($elem610);
              $this->fileIds []= $elem610;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->fileIds !== null) {
      ...
      $xfer += $output->writeFieldBegin('fileIds', TType::LST, 1);
      {
        $output->writeListBegin(TType::I64, count($this->fileIds));
        {
          foreach ($this->fileIds as $iter611)
          {
  ...
  public function write($output) {
    ...
    if ($this->metadata !== null) {
      ...
      $xfer += $output->writeFieldBegin('metadata', TType::LST, 2);
      {
        ...
        {
          foreach ($this->metadata as $iter625)
          {
  ...
  public function write($output) {
    ...
    if ($this->fileIds !== null) {
      ...
      $xfer += $output->writeFieldBegin('fileIds', TType::LST, 1);
      {
        $output->writeListBegin(TType::I64, count($this->fileIds));
        {
          foreach ($this->fileIds as $iter632)
          {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem638 = null;
              $elem638 = new \metastore\Function();
              $xfer += $elem638->read($input);
              $this->functions []= $elem638;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->functions !== null) {
      ...
      $xfer += $output->writeFieldBegin('functions', TType::LST, 1);
      {
        ...
        {
          foreach ($this->functions as $iter639)
          {
  ...
  public function write($output) {
    ...
    if ($this->values !== null) {
      ...
      $xfer += $output->writeFieldBegin('values', TType::LST, 1);
      {
        ...
        {
          foreach ($this->values as $iter646)
          {
            $xfer += $output->writeI32($iter646);
          }
        }
        $output->writeListEnd();
      }
  ...
  public function write($output) {
    ...
    if ($this->tblNames !== null) {
      ...
      $xfer += $output->writeFieldBegin('tblNames', TType::LST, 2);
      {
        ...
        {
          foreach ($this->tblNames as $iter653)
          {
  ...
  public function write($output) {
    ...
    if ($this->tables !== null) {
      ...
      $xfer += $output->writeFieldBegin('tables', TType::LST, 1);
      {
        ...
        {
          foreach ($this->tables as $iter660)
          {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::SET) {
            ...
            $_size661 = 0;
            $_etype664 = 0;
            $xfer += $input->readSetBegin($_etype664, $_size661);
            for ($_i665 = 0; $_i665 < $_size661; ++$_i665)
            {
              $elem666 = null;
              $xfer += $input->readString($elem666);
              if (is_scalar($elem666)) {
                $this->tablesUsed[$elem666] = true;
              } else {
                $this->tablesUsed []= $elem666;
              }
            }
            $xfer += $input->readSetEnd();
          } else {
        ...
        case 3:
          if ($ftype == TType::I32) {
            $xfer += $input->readI32($this->invalidationTime);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->tablesUsed !== null) {
      ...
      $xfer += $output->writeFieldBegin('tablesUsed', TType::SET, 2);
      {
        ...
        {
          foreach ($this->tablesUsed as $iter667 => $iter668)
          {
            if (is_scalar($iter668)) {
    ...
    if ($this->invalidationTime !== null) {
      $xfer += $output->writeFieldBegin('invalidationTime', TType::I32, 3);
      $xfer += $output->writeI32($this->invalidationTime);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
    $xfer += $output->writeStructEnd();
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem680 = null;
              $elem680 = new \metastore\WMMapping();
              $xfer += $elem680->read($input);
              $this->mappings []= $elem680;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 4:
          if ($ftype == TType::LST) {
            ...
            {
              $elem686 = null;
              $elem686 = new \metastore\WMTrigger();
              $xfer += $elem686->read($input);
              $this->triggers []= $elem686;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
        ...
        case 5:
          if ($ftype == TType::LST) {
            ...
            {
              $elem692 = null;
              $elem692 = new \metastore\WMPoolTrigger();
              $xfer += $elem692->read($input);
              $this->poolTriggers []= $elem692;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->mappings !== null) {
      ...
      $xfer += $output->writeFieldBegin('mappings', TType::LST, 3);
      {
        ...
        {
          foreach ($this->mappings as $iter694)
          {
    ...
    if ($this->triggers !== null) {
      ...
      $xfer += $output->writeFieldBegin('triggers', TType::LST, 4);
      {
        ...
        {
          foreach ($this->triggers as $iter695)
          {
    ...
    if ($this->poolTriggers !== null) {
      ...
      $xfer += $output->writeFieldBegin('poolTriggers', TType::LST, 5);
      {
        ...
        {
          foreach ($this->poolTriggers as $iter696)
          {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem702 = null;
              $elem702 = new \metastore\WMResourcePlan();
              $xfer += $elem702->read($input);
              $this->resourcePlans []= $elem702;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->resourcePlans !== null) {
      ...
      $xfer += $output->writeFieldBegin('resourcePlans', TType::LST, 1);
      {
        ...
        {
          foreach ($this->resourcePlans as $iter703)
          {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem709 = null;
              $elem709 = new \metastore\WMTrigger();
              $xfer += $elem709->read($input);
              $this->triggers []= $elem709;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->triggers !== null) {
      ...
      $xfer += $output->writeFieldBegin('triggers', TType::LST, 1);
      {
        $output->writeListBegin(TType::STRUCT, count($this->triggers));
        {
          foreach ($this->triggers as $iter710)
          {
