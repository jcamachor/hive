...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class Table implements org.apache.thrift.TBase<Table, Table._Fields>, java.io.Serializable, Cloneable, Comparable<Table> {
  ...
  private Map<String,NotificationEvent> creationSignature; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.CREATION_SIGNATURE, new org.apache.thrift.meta_data.FieldMetaData("creationSignature", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING), 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "NotificationEvent"))));
  ...
  public Table(Table other) {
    ...
    if (other.isSetCreationSignature()) {
      Map<String,NotificationEvent> __this__creationSignature = new HashMap<String,NotificationEvent>(other.creationSignature.size());
      for (Map.Entry<String, NotificationEvent> other_element : other.creationSignature.entrySet()) {

        String other_element_key = other_element.getKey();
        NotificationEvent other_element_value = other_element.getValue();

        String __this__creationSignature_copy_key = other_element_key;

        NotificationEvent __this__creationSignature_copy_value = other_element_value;
  ...
  public void putToCreationSignature(String key, NotificationEvent val) {
    if (this.creationSignature == null) {
      this.creationSignature = new HashMap<String,NotificationEvent>();
    }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case CREATION_SIGNATURE:
      if (value == null) {
        ...
        setCreationSignature((Map<String,NotificationEvent>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.creationSignature = new HashMap<String,NotificationEvent>(2*_map197.size);
                String _key198;
                NotificationEvent _val199;
                for (int _i200 = 0; _i200 < _map197.size; ++_i200)
                {
                  _key198 = iprot.readString();
                  _val199 = new NotificationEvent();
                  _val199.read(iprot);
      ...
      if (struct.creationSignature != null) {
        if (struct.isSetCreationSignature()) {
          oprot.writeFieldBegin(CREATION_SIGNATURE_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, NotificationEvent> _iter203 : struct.creationSignature.entrySet())
            {
      ...
      if (struct.isSetCreationSignature()) {
        {
          ...
          for (Map.Entry<String, NotificationEvent> _iter206 : struct.creationSignature.entrySet())
          {
      ...
      if (incoming.get(15)) {
        {
          ...
          struct.creationSignature = new HashMap<String,NotificationEvent>(2*_map214.size);
          String _key215;
          NotificationEvent _val216;
          for (int _i217 = 0; _i217 < _map214.size; ++_i217)
          {
            _key215 = iprot.readString();
            _val216 = new NotificationEvent();
            _val216.read(iprot);
