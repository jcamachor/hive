  ...
  private static class PutFileMetadataRequestTupleScheme extends TupleScheme<PutFileMetadataRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PutFileMetadataRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (long _iter700 : struct.fileIds)
        {
      ...
      }
      {
        ...
        for (ByteBuffer _iter701 : struct.metadata)
        {
          oprot.writeBinary(_iter701);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PutFileMetadataRequest struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TList _list702 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.fileIds = new ArrayList<Long>(_list702.size);
        long _elem703;
        for (int _i704 = 0; _i704 < _list702.size; ++_i704)
        {
          _elem703 = iprot.readI64();
          struct.fileIds.add(_elem703);
        }
      }
      struct.setFileIdsIsSet(true);
      {
        ...
        struct.metadata = new ArrayList<ByteBuffer>(_list705.size);
        ByteBuffer _elem706;
        for (int _i707 = 0; _i707 < _list705.size; ++_i707)
        {
          _elem706 = iprot.readBinary();
          struct.metadata.add(_elem706);
        }
      }
      struct.setMetadataIsSet(true);
