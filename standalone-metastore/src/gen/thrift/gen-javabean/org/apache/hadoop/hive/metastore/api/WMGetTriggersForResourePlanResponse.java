      ...
      if (struct.triggers != null) {
        if (struct.isSetTriggers()) {
          oprot.writeFieldBegin(TRIGGERS_FIELD_DESC);
          {
            ...
            for (WMTrigger _iter791 : struct.triggers)
            {
      ...
      if (struct.isSetTriggers()) {
        {
          ...
          for (WMTrigger _iter792 : struct.triggers)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.triggers = new ArrayList<WMTrigger>(_list793.size);
          WMTrigger _elem794;
          for (int _i795 = 0; _i795 < _list793.size; ++_i795)
          {
            _elem794 = new WMTrigger();
            _elem794.read(iprot);
            struct.triggers.add(_elem794);
          }
        }
        struct.setTriggersIsSet(true);
      }
