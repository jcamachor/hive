            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.functions = new ArrayList<Function>(_list716.size);
                Function _elem717;
                for (int _i718 = 0; _i718 < _list716.size; ++_i718)
                {
                  _elem717 = new Function();
                  _elem717.read(iprot);
                  struct.functions.add(_elem717);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.functions != null) {
        if (struct.isSetFunctions()) {
          oprot.writeFieldBegin(FUNCTIONS_FIELD_DESC);
          {
            ...
            for (Function _iter719 : struct.functions)
            {
      ...
      if (struct.isSetFunctions()) {
        {
          ...
          for (Function _iter720 : struct.functions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.functions = new ArrayList<Function>(_list721.size);
          Function _elem722;
          for (int _i723 = 0; _i723 < _list721.size; ++_i723)
          {
            _elem722 = new Function();
            _elem722.read(iprot);
            struct.functions.add(_elem722);
          }
        }
        struct.setFunctionsIsSet(true);
      }
