            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionVals = new ArrayList<String>(_list648.size);
                String _elem649;
                for (int _i650 = 0; _i650 < _list648.size; ++_i650)
                {
                  _elem649 = iprot.readString();
                  struct.partitionVals.add(_elem649);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partitionVals != null) {
        if (struct.isSetPartitionVals()) {
          oprot.writeFieldBegin(PARTITION_VALS_FIELD_DESC);
          {
            ...
            for (String _iter651 : struct.partitionVals)
            {
      ...
      if (struct.isSetPartitionVals()) {
        {
          ...
          for (String _iter652 : struct.partitionVals)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.partitionVals = new ArrayList<String>(_list653.size);
          String _elem654;
          for (int _i655 = 0; _i655 < _list653.size; ++_i655)
          {
            _elem654 = iprot.readString();
            struct.partitionVals.add(_elem654);
          }
        }
        struct.setPartitionValsIsSet(true);
      }
