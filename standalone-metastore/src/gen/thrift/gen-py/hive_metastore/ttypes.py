...
class Table:
  ...
  thrift_spec = (
    ...
    (16, TType.MAP, 'creationSignature', (TType.STRING,None,TType.STRUCT,(NotificationEvent, NotificationEvent.thrift_spec)), None, ), # 16
  )
  ...
  def __init__(self, tableName=None, dbName=None, owner=None, createTime=None, lastAccessTime=None, retention=None, sd=None, partitionKeys=None, parameters=None, viewOriginalText=None, viewExpandedText=None, tableType=None, privileges=None, temporary=thrift_spec[14][4], rewriteEnabled=None, creationSignature=None,):
    ...
    self.creationSignature = creationSignature
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.creationSignature)
    return value
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i554 in xrange(_size550):
            _elem555 = NotificationEvent()
            _elem555.read(iprot)
            self.events.append(_elem555)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class InsertEventRequestData:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i561 in xrange(_size557):
            ...
            self.filesAdded.append(_elem562)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.LIST:
          ...
          for _i567 in xrange(_size563):
            ...
            self.filesAddedChecksum.append(_elem568)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.filesAdded is not None:
      ...
      for iter569 in self.filesAdded:
    ...
    if self.filesAddedChecksum is not None:
      ...
      for iter570 in self.filesAddedChecksum:
...
class FireEventRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i575 in xrange(_size571):
            ...
            self.partitionVals.append(_elem576)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitionVals is not None:
      ...
      for iter577 in self.partitionVals:
...
class GetFileMetadataByExprResult:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i582 in xrange(_size578):
            ...
            _val584 = MetadataPpdResult()
            _val584.read(iprot)
            self.metadata[_key583] = _val584
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.metadata is not None:
      ...
      for kiter585,viter586 in self.metadata.items():
...
class GetFileMetadataResult:
  ...
  def write(self, oprot):
    ...
    if self.metadata is not None:
      ...
      for kiter601,viter602 in self.metadata.items():
...
class GetFileMetadataRequest:
  ...
  def write(self, oprot):
    ...
    if self.fileIds is not None:
      oprot.writeFieldBegin('fileIds', TType.LIST, 1)
      oprot.writeListBegin(TType.I64, len(self.fileIds))
      for iter609 in self.fileIds:
        oprot.writeI64(iter609)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i635 in xrange(_size631):
            _elem636 = Function()
            _elem636.read(iprot)
            self.functions.append(_elem636)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
