...
class Table
  ...
  FIELDS = {
    ...
    CREATIONSIGNATURE => {:type => ::Thrift::Types::MAP, :name => 'creationSignature', :key => {:type => ::Thrift::Types::STRING}, :value => {:type => ::Thrift::Types::STRUCT, :class => ::NotificationEvent}, :optional => true}
  }
