...
-- HIVE-22046 (DEFAULT HIVE(1))
ALTER TABLE TAB_COL_STATS ADD ENGINE int NOT NULL CONSTRAINT DEF_TAB_COL_STATS_ENGINE DEFAULT(1);
ALTER TABLE PART_COL_STATS ADD ENGINE int NOT NULL CONSTRAINT DEF_PART_COL_STATS_ENGINE DEFAULT(1);
