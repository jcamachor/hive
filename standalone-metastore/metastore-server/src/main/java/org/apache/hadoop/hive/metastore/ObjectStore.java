...
*/
  ...
  */
  ...
  private Map<String, MTableColumnStatistics> getPartitionColStats(Table table,
     List<String> colNames, Engine engine) throws NoSuchObjectException, MetaException {
    ...
    try {
      List<MTableColumnStatistics> stats = getMTableColumnStatistics(table,
          colNames, engine.getValue(), queryWrapper);
  ...
  private Map<String, MPartitionColumnStatistics> getPartitionColStats(Table table,
      String partitionName, List<String> colNames, Engine engine) throws NoSuchObjectException, MetaException {
    ...
    try {
      List<MPartitionColumnStatistics> stats = getMPartitionColumnStatistics(table,
          Lists.newArrayList(partitionName), colNames, engine.getValue(), queryWrapper);
  ...
  private List<MTableColumnStatistics> getMTableColumnStatistics(Table table, List<String> colNames, Integer engine, QueryWrapper queryWrapper)
      throws MetaException {
      ...
      List<MTableColumnStatistics> result =
          Batchable.runBatched(batchSize, colNames, new Batchable<String, MTableColumnStatistics>() {
            ...
            public List<MTableColumnStatistics> run(List<String> input)
              ...
              String paramStr = "java.lang.String t1, java.lang.String t2, java.lang.String t3, java.lang.Integer t4";
  ...
  public ColumnStatistics getTableColumnStatistics(
      ...
      Engine engine) throws MetaException, NoSuchObjectException {
    // Note: this will get stats without verifying ACID.
  ...
  protected ColumnStatistics getTableColumnStatisticsInternal(
      String catName, String dbName, String tableName, final List<String> colNames, Engine engine,
    ...
    return new GetStatHelper(normalizeIdentifier(catName), normalizeIdentifier(dbName),
      ...
      protected ColumnStatistics getSqlResult(GetHelper<ColumnStatistics> ctx) throws MetaException {
        return directSql.getTableStats(catName, dbName, tblName, colNames, engine.getValue(), enableBitVector);
      }
      @Override
      protected ColumnStatistics getJdoResult(
        ...
        List<MTableColumnStatistics> mStats =
            getMTableColumnStatistics(getTable(), colNames, engine.getValue(), queryWrapper);
        if (mStats.isEmpty()) {
          return null;
        }
  ...
  public List<ColumnStatistics> getPartitionColumnStatistics(String catName, String dbName, String tableName,
      List<String> partNames, List<String> colNames, Engine engine) throws MetaException, NoSuchObjectException {
    // Note: this will get stats without verifying ACID.
  ...
  protected List<ColumnStatistics> getPartitionColumnStatisticsInternal(
      ...
      Engine engine, boolean allowSql, boolean allowJdo) throws MetaException, NoSuchObjectException {
    final boolean enableBitVector = MetastoreConf.getBoolVar(getConf(), ConfVars.STATS_FETCH_BITVECTOR);
    return new GetListHelper<ColumnStatistics>(catName, dbName, tableName, allowSql, allowJdo) {
      ...
      protected List<ColumnStatistics> getSqlResult(
        ...
        return directSql.getPartitionStats(catName, dbName, tblName, partNames, colNames, engine.getValue(), enableBitVector);
      }
      @Override
      protected List<ColumnStatistics> getJdoResult(
        ...
        try {
          List<MPartitionColumnStatistics> mStats =
              getMPartitionColumnStatistics(getTable(), partNames, colNames, engine.getValue(), queryWrapper);
          List<ColumnStatistics> result = new ArrayList<>(
  ...
  public AggrStats get_aggr_stats_for(String catName, String dbName, String tblName,
      ...
      Engine engine, String writeIdList) throws MetaException, NoSuchObjectException {
    // If the current stats in the metastore doesn't comply with
  ...
  @Override
  public AggrStats get_aggr_stats_for(String catName, String dbName, String tblName,
      final List<String> partNames, final List<String> colNames, Engine engine)
      throws MetaException, NoSuchObjectException {
    ...
    return new GetHelper<AggrStats>(catName, dbName, tblName, true, false) {
      ...
      protected AggrStats getSqlResult(GetHelper<AggrStats> ctx)
        ...
        return directSql.aggrColStatsForPartitions(catName, dbName, tblName, partNames,
            colNames, engine.getValue(), useDensityFunctionForNDVEstimation, ndvTuner, enableBitVector);
      }
      @Override
  ...
  private List<MPartitionColumnStatistics> getMPartitionColumnStatistics(
      Table table, List<String> partNames, List<String> colNames, Integer engine, QueryWrapper queryWrapper)
          throws NoSuchObjectException, MetaException {
    boolean committed = false;
      ...
      if (colName != null) {
        ...
        parameters =
            "java.lang.String t1, java.lang.String t2, "
                + "java.lang.String t3, java.lang.String t4, java.lang.String t5" + (engine != null ? ", java.lang.Integer t6" : "");
      } else {
        filter = "partition.partitionName == t1 && dbName == t2 && tableName == t3 && catName == t4" + (engine != null ? " && engine == t5" : "");
        parameters = "java.lang.String t1, java.lang.String t2, java.lang.String t3, java.lang.String t4" + (engine != null ? ", java.lang.Integer t5" : "");
      }
      query.setFilter(filter);
  ...
  public boolean deleteTableColumnStatistics(String catName, String dbName, String tableName,
    ...
    try {
      ...
      if (colName != null) {
        ...
        parameters = "java.lang.String t1, java.lang.String t2, java.lang.String t3" + (engine != null ? ", java.lang.Integer t4" : "");
      }
