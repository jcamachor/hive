...
class MetaStoreDirectSql {
  ...
  public ColumnStatistics getTableStats(final String catName, final String dbName,
      final String tableName, List<String> colNames, Integer engine,
  ...
  public AggrStats aggrColStatsForPartitions(String catName, String dbName, String tableName,
      List<String> partNames, List<String> colNames, Integer engine,
  ...
  private long partsFoundForPartitions(
      ...
      final List<String> partNames, List<String> colNames, Integer engine) throws MetaException {
  ...
  private List<ColumnStatisticsObj> columnStatisticsObjForPartitions(
      ...
      List<String> colNames, Integer engine, long partsFound, final boolean useDensityFunctionForNDVEstimation,
  ...
  private List<ColumnStatisticsObj> columnStatisticsObjForPartitionsBatch(String catName, String dbName,
      String tableName, List<String> partNames, List<String> colNames, Integer engine,
  ...
  private List<ColumnStatisticsObj> aggrStatsUseJava(String catName, String dbName, String tableName,
      List<String> partNames, List<String> colNames, Integer engine, boolean areAllPartsFound,
  ...
  private Object[] prepareParams(String catName, String dbName, String tableName,
      List<String> partNames, List<String> colNames, Integer engine) throws MetaException {
  ...
  public List<ColumnStatistics> getPartitionStats(
      final String catName, final String dbName, final String tableName, final List<String> partNames,
      List<String> colNames, Integer engine, boolean enableBitVector) throws MetaException {
    if (colNames.isEmpty() || partNames.isEmpty()) {
      return Collections.emptyList();
    }
    final boolean doTrace = LOG.isDebugEnabled();
  ...
  private ColumnStatistics makeColumnStats(
      List<Object[]> list, ColumnStatisticsDesc csd, int offset, int engine) throws MetaException {
    ...
    result.setEngine(Engine.findByValue(engine));
    return result;
  }
