...
public class TimestampColumnStatsMerger extends ColumnStatsMerger {
  ...
  public void merge(ColumnStatisticsObj aggregateColStats, ColumnStatisticsObj newColStats) {
    ...
    Timestamp lowValue = min(aggregateData.getLowValue(), newData.getLowValue());
    aggregateData.setLowValue(lowValue);
    Timestamp highValue = max(aggregateData.getHighValue(), newData.getHighValue());
  ...
  private Timestamp min(Timestamp v1, Timestamp v2) {
    if (v1 == null || v2 == null) {
      if (v1 != null) {
        return v1;
      } else {
  ...
  private Timestamp max(Timestamp v1, Timestamp v2) {
    if (v1 == null || v2 == null) {
      if (v1 != null) {
        return v1;
      } else {
