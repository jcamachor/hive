...
public interface IMetaStoreClient {
   ...
   *           In case the table wasn't found.
   */
  Table getTable(String dbName, String tableName, boolean getColumnStats, Engine engine) throws MetaException,
          TException, NoSuchObjectException;
  /**
   * Get a table object.
   * @param catName catalog the table is in.
  ...
  List<Partition> getPartitionsByNames(String db_name, String tbl_name, List<String> part_names,
      boolean getColStats, Engine engine) throws NoSuchObjectException, MetaException, TException;
  ...
  Map<String, List<ColumnStatisticsObj>> getPartitionColumnStatistics(String dbName,
      String tableName,  List<String> partNames, List<String> colNames, Engine engine)
          throws NoSuchObjectException, MetaException, TException;
  ...
  Map<String, List<ColumnStatisticsObj>> getPartitionColumnStatistics(
      ...
      Engine engine) throws NoSuchObjectException, MetaException, TException;
  ...
  boolean deletePartitionColumnStatistics(String dbName, String tableName,
    String partName, String colName, Engine engine) throws NoSuchObjectException, MetaException,
  ...
  boolean deletePartitionColumnStatistics(String catName, String dbName, String tableName,
      String partName, String colName, Engine engine)
   ...
   */
   boolean deleteTableColumnStatistics(String dbName, String tableName, String colName, Engine engine) throws
   ...
   * @throws InvalidInputException bad input, like a null table name.
   */
  boolean deleteTableColumnStatistics(String catName, String dbName, String tableName, String colName, Engine engine)
      throws NoSuchObjectException, MetaException, InvalidObjectException, TException, InvalidInputException;
  ...
  AggrStats getAggrColStatsFor(String dbName, String tblName,
      List<String> colNames, List<String> partName, Engine engine)  throws NoSuchObjectException, MetaException, TException;

  AggrStats getAggrColStatsFor(String dbName, String tblName,
      List<String> colNames, List<String> partName,
      Engine engine, String writeIdList)  throws NoSuchObjectException, MetaException, TException;
