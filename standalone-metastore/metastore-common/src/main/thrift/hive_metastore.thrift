...
5: required Engine engine //engine creating the current request
}
...
struct TableStatsRequest {
 ...
 6: required Engine engine //engine creating the current request
}
...
struct PartitionsStatsRequest {
 ...
 7: required Engine engine //engine creating the current request
}
...
service ThriftHiveMetastore extends fb303.FacebookService
{
  ...
  bool delete_partition_column_statistics(1:string db_name, 2:string tbl_name, 3:string part_name, 4:string col_name, 5:Engine engine) throws
              (1:NoSuchObjectException o1, 2:MetaException o2, 3:InvalidObjectException o3,
               4:InvalidInputException o4)
  bool delete_table_column_statistics(1:string db_name, 2:string tbl_name, 3:string col_name, 4:Engine engine) throws
              (1:NoSuchObjectException o1, 2:MetaException o2, 3:InvalidObjectException o3,
               4:InvalidInputException o4)
