...
import org.apache.hadoop.hive.ql.optimizer.calcite.HiveMaterializedViewsRelMetadataProvider;
  ...
  private class CalcitePlannerAction implements Frameworks.PlannerAction<RelNode> {
    ...
    private RelNode applyMaterializedViewRewriting(RelOptPlanner planner, RelNode basePlan,
      ...
      if (!materializations.isEmpty()) {
        ...
        // Use materialized views specific cost model
        optCluster.invalidateMetadataQuery();
        RelMetadataQuery.THREAD_PROVIDERS.set(JaninoRelMetadataProvider.of(HiveMaterializedViewsRelMetadataProvider.INSTANCE));
